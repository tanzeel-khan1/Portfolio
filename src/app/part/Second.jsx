...
//             <span className="font-semibold text-blue-500"> JavaScript</span>,
//             and
//             <span className="font-semibold text-blue-500"> React.js</span>. I
//             also work with{" "}
//             <span className="font-semibold text-blue-500"> Next.js</span>,
//             <span className="font-semibold text-blue-500"> Tailwind CSS</span>{" "}
//             for modern UI design, and
//             <span className="font-semibold text-blue-500">
//               {" "}
//               Framer Motion
//             </span>{" "}
//             to create smooth animations. Additionally, I have experience with
//             the
//             <span className="font-semibold text-blue-500"> MERN Stack</span> to
//             build full-stack applications. My focus is on building clean,
