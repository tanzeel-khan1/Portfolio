...
import { SiJavascript, SiNextdotjs, SiTailwindcss, SiMongodb, SiExpress, SiRedux } from "react-icons/si";
    ...
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          I have expertise in modern web development technologies and frameworks.
        </motion.p>
